...
public class FileUpload {
    ...
    public String getPublicUrl(String bucketName, String objectName) {
        ...
        return minioProperties.getEndpoint() + "/api/v1/buckets/" + bucketName + "/objects/download?preview=true&prefix="+objectName+ "&version_id=null";
    }
